            ...
            <>
              {data.nooca_nat == 0 ? (
                <Link to={`/Acount/Myorder`} key={data.UserId}>
                  <div className="msg">
                    <h2>
                      Waxaa lagaa soo dalbaday <span>{data.title}</span> .
                    </h2>
                    <p>
                      <FontAwesomeIcon icon={faClock} />{" "}
                      <span>{format(data.CreatedAt)} </span>{" "}
                      <span className="Xaalad">
                ...
                <Link to={`/Acount/Myorder`} key={data.UserId}>
                  <div className="msg">
                    <h2>
                      Waa Laga Labtay <span>{data.title}</span> .
                    </h2>
                    <p>
                      <FontAwesomeIcon icon={faClock} />{" "}
                      <span>{format(data.CreatedAt)} </span>{" "}
                ...
                <Link to={`/Acount/Rasiid`} key={data.UserId}>
                  <div className="msg">
                    <h2>
                      Waa La Gudoomay Dalabkan <span>{data.title}</span> .
                    </h2>
                    <p>
                      <FontAwesomeIcon icon={faClock} />{" "}
                      <span>{format(data.CreatedAt)} </span>{" "}
                ...
                <Link to={`/Acount/orders`} key={data.UserId}>
                  <div className="msg">
                    <h2>
                      Waa La Aqbalay Dalabkan <span>{data.title}</span> .
                    </h2>
                    <p>
                      <FontAwesomeIcon icon={faClock} />{" "}
                      <span>{format(data.CreatedAt)} </span>{" "}
                ...
                <Link to={`/Acount/orders`} key={data.UserId}>
                  <div className="msg">
                    <h2>
                      Hanbalyo ! Waa Lagu Dhameeyay Dalabkan
